...
module.exports = options => ({
  ...
  code(input, filepath) {
    ...
    try {
      ...
      const extractedCSS = _parse.extractedCSS,
  ...
  result(stylelintResult, filepath) {
    ...
    !(warning.rule === 'indentation' && interpolationLines.indexOf(lineCorrection[warning.line]) >= 0)).map(warning => Object.assign({}, warning, {
